    ...
    BroadcastReceiver br = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(intent.ACTION_BATTERY_CHANGED)) {
                ...
                if (remain >= 90) im1.setImageResource(R.drawable.bat100);
                else if (remain >= 70) im1.setImageResource(R.drawable.bat80);
                else if (remain >= 50) im1.setImageResource(R.drawable.bat60);
                else if (remain >= 30) im1.setImageResource(R.drawable.bat40);
                else if (remain >= 10) im1.setImageResource(R.drawable.bat20);
                ...
                switch (status) {
                    ...
                    case BatteryManager.BATTERY_STATUS_FULL:
                        Toast.makeText(getApplicationContext(), "Battery Status: Full Charging",
                                Toast.LENGTH_SHORT).show();
                        break;
                    case BatteryManager.BATTERY_STATUS_NOT_CHARGING:
                        Toast.makeText(getApplicationContext(), "Battery Status: Not Charging",
                                Toast.LENGTH_SHORT).show();
                        break;
                    default:
